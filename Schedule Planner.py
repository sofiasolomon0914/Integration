...
while moodLoop:
    ...
    if userMood == "nervous":
        ...
        moodLoop = False
    if userMood == "tense":
        print("\nGo somewhere you can relax. Maybe have some tea, get some food, or go watch a movie. Maybe get a "
              "message.")
        userMood = False
    if userMood == "upset":
        print("\nOh no! Go run or go somewhere else you can relax.")
        userMood = False
    if userMood == "depressed":
        print("\nIt will get better! Make yourself a tea, read a book, then go take a nap!")
        userMood = False
    if userMood == "calm":
        print("Try something zen like meditation or yoga.")
        userMood = False
